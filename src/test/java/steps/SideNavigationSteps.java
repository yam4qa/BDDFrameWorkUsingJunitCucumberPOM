...
public class SideNavigationSteps 
{
	WebDriver driver;
	LoginPage loginPage;
	...
	public void user_able_to_login_and_go_to_DashBoard_page(){
	...
	public void user_able_to_add_newBankAccount_details(String title, String description, String balance) throws InterruptedException
	{
